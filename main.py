...
def main():
    ...
    radio_value = st.sidebar.radio(
        "Select Search Backend Base Search.net True /or Experimental False",
        [True, False],
    )
    ...
    if author_name:
        ...
        author_specific_frame, fig = grand_distribution_plot(
            ar, scraped_labels, standard_sci, art_frame, author_name=author_name
        )
